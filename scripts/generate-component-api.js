...
function main() {
    ...
    const output = {
        meta: {
            ...
            handfish_commit: git.shortHash,
            handfish_dirty: git.dirty,
            note: 'Auto-generated by scripts/generate-component-api.js. Do not edit by hand. Re-run after any change to src/components/, src/utils/, or src/styles/themes/.',
        },
